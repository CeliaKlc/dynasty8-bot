...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const embedPrincipal = new EmbedBuilder()
      .setColor(0x2ECC71)
      .setTitle('<:Dynasty8:1489223936620236841> Vendre votre bien avec Le-Bon-Coin')
      .setDescription(
        ...
        `\n` +
        `Dynasty 8 est ravi de vous accompagner dans la vente de votre bien immobilier. <:Dynasty8:1489223936620236841>`
      );
